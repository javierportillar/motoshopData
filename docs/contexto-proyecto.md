...
| **R14** | Prophet y LightGBM siguen en el pipeline pese a ser inservibles | 🟡 Aceptado · **diferido a F5** (decisión revisor 2026-05-30) | Métricas honestas post-FIX1 muestran WAPE Prophet 864% / LightGBM 57% vs Baseline 45.83% — ambos peores que baseline. Lecciones aprendidas §5 recomiendan removerlos. **Trigger:** kickoff F5 — primer sprint debe limpiar `infra/run_forecast_prophet.py`, `infra/run_forecast_lightgbm.py`, y dejar solo baseline + classifier en producción. |
