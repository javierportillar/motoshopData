...
-- MAGIC %md
-- MAGIC # 21 · Forecast LightGBM SKU
-- MAGIC
-- MAGIC DDL para la tabla de predicciones del modelo LightGBM.
-- MAGIC Los datos se insertan desde infra/run_forecast_lightgbm.py vía Databricks SQL.

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS motoshop.gold.forecast_lightgbm_sku (
  sku STRING,
  forecast_date DATE,
  horizon INT,
...
SELECT * FROM motoshop.gold.forecast_lightgbm_sku LIMIT 10;
